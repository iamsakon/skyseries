...
public interface RoomLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RoomLocalServiceUtil} to access the room local service. Add custom service methods to {@link com.sky.skyseries.apm.service.impl.RoomLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Room fetchRoomByUuidAndGroupId(java.lang.String uuid, long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Room getRoomByUuidAndGroupId(java.lang.String uuid, long groupId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Room> getRoomsByUuidAndCompanyId(java.lang.String uuid,
		long companyId);
