...
/**
 * Provides the local service interface for Building. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see BuildingLocalServiceUtil
...
public interface BuildingLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link BuildingLocalServiceUtil} to access the building local service. Add custom service methods to {@link com.sky.skyseries.apm.service.impl.BuildingLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public Building createBuilding(long buildingId);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Building deleteBuilding(long buildingId) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Building fetchBuilding(long buildingId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Building fetchBuildingByUuidAndGroupId(java.lang.String uuid,
		long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Building getBuilding(long buildingId) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Building getBuildingByUuidAndGroupId(java.lang.String uuid,
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Building> getBuildings(int start, int end);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Building> getBuildingsByUuidAndCompanyId(
