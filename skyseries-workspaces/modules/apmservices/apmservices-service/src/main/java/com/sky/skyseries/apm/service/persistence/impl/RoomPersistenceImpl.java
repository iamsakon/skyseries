...
import com.sky.skyseries.apm.exception.NoSuchRoomException;
import com.sky.skyseries.apm.model.Room;
import com.sky.skyseries.apm.model.impl.RoomImpl;
import com.sky.skyseries.apm.model.impl.RoomModelImpl;
 ...
 * @see RoomPersistence
 * @see com.sky.skyseries.apm.service.persistence.RoomUtil
 * @generated
 */
@ProviderType
public class RoomPersistenceImpl extends BasePersistenceImpl<Room>
	...
	public void clearCache(Room room) {
		...
		clearUniqueFindersCache((RoomModelImpl)room);
	}
	...
	public Room updateImpl(Room room) {
		...
		clearUniqueFindersCache(roomModelImpl);
		cacheUniqueFindersCache(roomModelImpl, isNew);
	...
	protected Room toUnwrappedModel(Room room) {
		...
		roomImpl.setFloorId(room.getFloorId());
		roomImpl.setRoomStatusId(room.getRoomStatusId());
